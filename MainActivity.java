...
public class MainActivity extends Activity {
    ...
    /** Open any local path or content URI with a sensible MIME type. */
    private void openDocumentFlexible(String pathOrUri) {
        if (pathOrUri == null || pathOrUri.isEmpty()) {
            Toast.makeText(this, "Cannot open: empty path", Toast.LENGTH_LONG).show();
            return;
        }
        try {
            Uri uri;
            ...
            if (pathOrUri.startsWith("content://")) {
                ...
                if (!file.exists()) {
                    Toast.makeText(this, "File not found:\n" + pathOrUri, Toast.LENGTH_LONG).show();
                    return;
                }
                if (!file.canRead()) {
                    Toast.makeText(this, "File not readable:\n" + pathOrUri, Toast.LENGTH_LONG).show();
                    return;
                }
            ...
            runOnUiThread(() -> {
                if (path == null || path.trim().isEmpty()) {
                    Toast.makeText(MainActivity.this,
                            "Cannot open: empty path", Toast.LENGTH_LONG).show();
                    return;
                }
                try {
